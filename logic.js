...
// function to update appearance of a tilebased on its number
...
function slide(row) {
  ...
  // this for loop will check if there are 2 adjecent numbers that are equal and will compare then and change the value of the second number to 0
...
// Create a function that will check if there is an empty file or not in the board
// Return boolean
